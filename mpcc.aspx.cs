...
public partial class mpcc : System.Web.UI.Page
{
    ...
    {
      //  if (strMyUrl == "http://localhost:49234/myctin/mpcc.aspx?shidori" || strMyUrl == "http://localhost:49234/myctin/mpcc.aspx/shidori")

        if (strMyUrl == "http://www.myct.in/mpcc.aspx?shidori" || strMyUrl == "http://www.myct.in/mpcc.aspx/shidori")
        {
            string sql = "select filename from committeedetail where Id=41";
