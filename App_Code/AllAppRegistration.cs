...
public class AllAppRegistration : System.Web.Services.WebService
{
    ...
    #region GetRegistrationUserMaster
        ...
        try
        {
            ...
            else
            {
                ...
                if (ds.Tables[0].Rows.Count == 0)
                {
                    ...
                    {
                        //-------OTP-------------------------------when IMEI No Already Present--------
                        //Random rand = new Random();
                        //string passwordStr = rand.Next(1, 9999).ToString();
                        //string str = "update [Come2myCityDB].[come2mycity].[IMEI_SMS_WSData] set otp='"+passwordStr+"' where WsMobileNo='"+AppMobileNo+"'";
                        //int s = cc.ExecuteNonQuery(str);
                        //return passwordStr; //ur OTP For This App and UR MobileNo
                    ...
                    if (i == 1)
                    {
                        ...
                        //               " with Event as( " +
                        //               " select *from( " +
                        //               " (SELECT [firstName],[RefMobileNo] as uid FROM [Come2myCityDB].[dbo].[EzeeDrugsAppDetail] where [RefMobileNo]='" + RefmobileNo + "' and keyword='EZEESCHOOLAPP')as table1 " +
                        //               " inner join " +
                        ...
                        //    {
                        //        string str2 = "insert into [Come2myCityDB].[dbo].[tbl_TreeDemo]([SMobile_No],[Senior_ID],[Child_ID],[Name],[Mobile_No],[Keyword],Role)values('" + RefmobileNo + "','" + s + "','" + getuserID + "','" + firstName + "','" + AppMobileNo + "','" + keyword + "','"+typeOfUse_Id+"')";
                        ...
                        //                  " with Event as( " +
                        //                  " select *from( " +
                        //                  " (SELECT [firstName],[RefMobileNo] as uid FROM [Come2myCityDB].[dbo].[EzeeDrugsAppDetail] where [RefMobileNo]='" + RefmobileNo + "' and keyword='CLASSAPP')as table1 " +
                        //                  " inner join " +
                        //                  " [Come2myCityDB].[dbo].[UserMaster] as table2 " +
                        //                  " on " +
                        //                  " table1.uid=table2.[usrMobileNo] " +
                        ...
                        //    {
                        //        // string str2 = "insert into [Come2myCityDB].[dbo].[tbl_TreeDemo]([SMobile_No],[Senior_ID],[Child_ID],[Name],[Mobile_No])values('NULL','NULL','" + result + "','" + firstName + "','" + AppMobileNo + "')";
                        //        string str2 = "insert into [Come2myCityDB].[dbo].[tbl_TreeDemo]([Child_ID],[Name],[Mobile_No],[Keyword])values('" + getuserID + "','" + firstName + "','" + AppMobileNo + "','" + keyword + "','"+typeOfUse_Id+"')";
                        //        int result1 = cc.ExecuteNonQuery(str2);

                        //    }
                        //    string  sql8 = "select usrFirstName,usrLastName,usrMobileNo,usrAddress,usrPassword from UserMaster where usrUserId='" + getuserID + "'";
                        //    ds = cc.ExecuteDataset(sql8);
                        //    string Password = ds.Tables[0].Rows[0]["usrPassword"].ToString();

                        //    //ClassAppDetailsToEzeeTest.InsertClassAppRegistration objclassapp = new InsertClassAppRegistration();
                        //    // objclassapp.InsertClassAppDetailsToeZeeTest(firstName, lastName, firmName, AppMobileNo, Password,address, eMailId, typeOfUse_Id, RefmobileNo, strDevId);
                            
                        //        Data = "1";
                            
                           
                        //}
                        //else if(keyword=="EZEEMARKETING")
                        //{
                        //    Data = "1";
                        //}
                        ...
                        //              " with Event as( " +
                        //              " select *from( " +
                        //              " (SELECT [firstName],[RefMobileNo] as uid FROM [Come2myCityDB].[dbo].[EzeeDrugsAppDetail] where [RefMobileNo]='" + RefmobileNo + "' and keyword='EZEESTORM')as table1 " +
                        //              " inner join " +
                        //              " [Come2myCityDB].[dbo].[UserMaster] as table2 " +
                        //              " on " +
                        //              " table1.uid=table2.[usrMobileNo] " +
                        ...
                        else if (keyword == "BACHATGAT")
                        {
                            string str =
                                        " with Event as( " +
                                        " select *from( " +
                                        " (SELECT [firstName],[RefMobileNo] as uid FROM [Come2myCityDB].[dbo].[EzeeDrugsAppDetail] where [RefMobileNo]='" + RefmobileNo + "' and keyword='BACHATGAT')as table1 " +
                                        " inner join " +
                                        " [Come2myCityDB].[dbo].[UserMaster] as table2 " +
                                        " on " +
                                        " table1.uid=table2.[usrMobileNo] " +
                            ...
                            {
                                // string str2 = "insert into [Come2myCityDB].[dbo].[tbl_TreeDemo]([SMobile_No],[Senior_ID],[Child_ID],[Name],[Mobile_No])values('NULL','NULL','" + result + "','" + firstName + "','" + AppMobileNo + "')";
                                string str2 = "insert into [Come2myCityDB].[dbo].[tbl_TreeDemo]([Child_ID],[Name],[Mobile_No],[Keyword],Role)values('" + getuserID + "','" + firstName + "','" + AppMobileNo + "','" + keyword + "','"+typeOfUse_Id+"')";
                                int result1 = cc.ExecuteNonQuery(str2);
                ...
                else
                {
                    ...
                    if (i == 1)
                    {
                        if (keyword == "EZEETEST")//Sending Data to ezeeTest Server
                        {
                            string str = "select usrFirstName,usrLastName,usrMobileNo,usrAddress,usrPassword from UserMaster where usrUserId='" + getuserID + "'";
                            ds = cc.ExecuteDataset(str);
                            string fullName = ds.Tables[0].Rows[0]["usrFirstName"].ToString() + " " + ds.Tables[0].Rows[0]["usrLastName"].ToString();
                        ...
                        //    OnExam.classregistration(strSimSerialNo, firmName, firstName, lastName, AppMobileNo, eMailId, address, pincode, RefmobileNo);
                        //}
                        //else if (keyword == "EZEESCHOOLAPP")//Update For TreeDemo Data
                        //{
                        ...
                        //    //string passwordStr = rand.Next(1, 9999).ToString();
                        //    //string str = "update [Come2myCityDB].[come2mycity].[IMEI_SMS_WSData] set otp='"+passwordStr+"' where WsMobileNo='"+AppMobileNo+"'";
                        //    ////string sql = "update [Come2myCityDB].[dbo].[EzeeDrugsAppDetail] set otp='"+passwordStr+"' where mobileNo='"+AppMobileNo+"'";
                        //    ////int s1 = cc.ExecuteNonQuery(sql);
                        //    //int s = cc.ExecuteNonQuery(str);
                        //    //return passwordStr + "ur Device Changed alredy present for this App"; 
                        ...
                        //    string str4 = "update [Come2myCityDB].[dbo].[tbl_TreeDemo] set SMobile_No='" + RefmobileNo + "',Senior_ID='" + sql1 + "',Name='"+firstName+"' where Child_ID='" + getuserID + "'";
                        ...
                        //    Data = "1";
                        //}
                        //else if (keyword == "CLASSAPP")//Update for Tree Demo Data
                        //{
                        //    string str =
                        //                " with Event as( " +
                        //                " select *from( " +
                        ...
                        //    string sr = "select usrFirstName,usrLastName,usrMobileNo,usrAddress,usrPassword from UserMaster where usrUserId='" + getuserID + "'";
                        ...
                        ////    Data = "1";
                        ////}
                        //else if (keyword == "TRUEVOTER")//Update Data For TreeDemo
                        //{
                        //    string str1 = "select usrUserId from UserMaster where usrMobileNo='" + AppMobileNo + "'";
                        //    string result = cc.ExecuteScalar(str1);
                        //    string str =
                        //                " with Event as( " +
                        //                " select *from( " +
                        //                " (SELECT [firstName],[RefMobileNo] as uid FROM [Come2myCityDB].[dbo].[EzeeDrugsAppDetail] where [RefMobileNo]='" + RefmobileNo + "' and keyword='TRUEVOTER')as table1 " +
                        //                " inner join " +
                        //                " [Come2myCityDB].[dbo].[UserMaster] as table2 " +
                        //                " on " +
                        //                " table1.uid=table2.[usrMobileNo] " +
                        ...
                        //    Data = "1";
                        //}
                        else if (keyword == "BACHATGAT")//Update For Bachatgat TreeDemo
                        {
                        ...
                        //else if (keyword == "EZEEPLANNER")//Update For TreeDemo
                        //{
    ...
    //-----------------------------------------------------OTP Registrations Check-----------------------------------------------------------------------------------

    #region CheckOTP
    [WebMethod]
    public string chkOTP(string AppMobileNo, string OTP)
    {
        SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.AppSettings["ConnectionString"]);
        SqlCommand cmd = new SqlCommand();
        string otpstr = "select otp from where [Come2myCityDB].[come2mycity].[IMEI_SMS_WSData] where WSMobileNo='" + AppMobileNo + "'";
        cmd.CommandText = otpstr;
        otpstr = cmd.ExecuteScalar().ToString();
        if (OTP.ToString() == otpstr.ToString())
        {
            string otpinsert = "update [Come2myCityDB].[come2mycity].[IMEI_SMS_WSData] set OTP='Null' where WSMobileNo='" + AppMobileNo + "'";
            cmd.CommandText = otpinsert;
