<%@ Page Language="C#" MasterPageFile="~/Master/MarketingMaster.master" AutoEventWireup="true"
    CodeFile="GovtJobEmployer.aspx.cs" Inherits="MarketingAdmin_GovtJobEmployer"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td>
                <ajax:TabContainer ID="JobRecruitment" runat="server" Width="100%" ActiveTabIndex="0"
                    AutoPostBack="true">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2">
                                        <asp:RadioButtonList ID="rdbCompanyType" runat="server">
                                            ...
                                            <asp:ListItem Text="SemiGovernment" Value="1"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="3" align="center" class="tdLabelInner">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:Button ID="btnCancelCompany" runat="server" CssClass="button" OnClick="btnCancelCompany_Click"
                                            Text="Cancel" />
                                    </td>
                                </tr>
                            </table>
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 32%">
                                        <asp:ListBox ID="lstqualification" runat="server" SelectionMode="Multiple" Height="92px"
                                            Width="99px"></asp:ListBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCompanyName1" runat="server" CssClass="tdText" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtaddress1" runat="server" CssClass="tdText" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:FileUpload ID="fileAdvertise" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="center">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lbldateofadvertisement" runat="server" Text="Date of Advertisement"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblFrom" runat="server" Text="From"></asp:Label><asp:TextBox ID="txtFrom"
                                                runat="server" CssClass="tdText"></asp:TextBox><ajax:CalendarExtender
                                                    ID="CalenderDate_From" runat="server" TargetControlID="txtFrom" Enabled="True">
                                                </ajax:CalendarExtender>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblTo" runat="server" Text="To"></asp:Label><asp:TextBox ID="txtTo"
                                                runat="server" CssClass="tdText"></asp:TextBox><ajax:CalendarExtender
                                                    ID="CalendarDate_To" runat="server" TargetControlID="txtTo" Enabled="True">
                                                </ajax:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 74px">
                                            <asp:Label ID="lblAdvertiseTo" runat="server" Text="Advertisment In:"></asp:Label>
                                        </td>
                                        <td style="height: 74px">
                                            <asp:ListBox ID="lstNewspaper" runat="server" SelectionMode="Multiple">
                                                <asp:ListItem>SAKAL</asp:ListItem>
                                                <asp:ListItem>LOKMAT</asp:ListItem>
                                                <asp:ListItem>MATA</asp:ListItem>
                                                <asp:ListItem>DESHONNATI</asp:ListItem>
                                                <asp:ListItem>NBP</asp:ListItem>
                                                <asp:ListItem>YUVANXT</asp:ListItem>
                                            </asp:ListBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="center">
                                            <asp:Button ID="btnSubmit1" runat="server" Text="Submit" CssClass="button" OnClick="btnSubmit1_Click" />
                                            &nbsp;
                                                    ...
                                                    <div class="rounded">
                                                        ...
                                                        <div class="mid-outer">
                                                            <div class="mid-inner">
                                                                <div class="mid">
                                                                    <div class="pager">
                                                                        <asp:GridView ID="gvViewAdvertise" runat="server" Width="74%" CssClass="mGrid" CellPadding="5"
                                                                            AutoGenerateColumns="False" EmptyDataText="Not uploaded any advertise">
                                                                            <Columns>
                                                                               <%-- <asp:BoundField HeaderText="Id" DataField="id" Visible="False">
                                                                                    <HeaderStyle HorizontalAlign="Left" Width="30%"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                                                                                ...
                                                                                <asp:BoundField HeaderText="FileName" DataField="adv_file">
                                                                                    <HeaderStyle HorizontalAlign="Left" Width="30%"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                                                                                </asp:BoundField>
                                                                                <asp:BoundField HeaderText="Advertise From" DataField="advertise_from">
                                                                                    <HeaderStyle HorizontalAlign="Left" Width="30%"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                                                                                </asp:BoundField>
                                                                                <asp:BoundField HeaderText="Advertise To" DataField="advertise_to">
                                                                                    <HeaderStyle HorizontalAlign="Left" Width="30%"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                                                                                </asp:BoundField>
                                                                                <asp:BoundField HeaderText="Advertisement In" DataField="advertise_in">
                                                                                    <HeaderStyle HorizontalAlign="Left" Width="30%"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                                                                                </asp:BoundField>
                                                                                 <asp:BoundField HeaderText="Status" DataField="adv_status">
                                                                                    <HeaderStyle HorizontalAlign="Left" Width="30%"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                                                                                </asp:BoundField>
                                                                            </Columns>
                                                                        ...
                                                                        <asp:Label ID="Label9" runat="server" Visible="False"></asp:Label></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="bottom-outer">
