...
public partial class MarketingAdmin_UdiseSmsReport : System.Web.UI.Page
{
        ...
        try
        {
            ...
            else
            {
                ...
                string Sql = "Select SendFrom ,count(*) as TotalSMSSend,sentMessage,smslength,EntryDate " +
                             "From UDISE_SendSMSReport where SendFrom='" + Convert.ToString(txtMobileNo.Text) + "'";
    ...
    protected void btnBill_Click(object sender, EventArgs e)
    {
        ...
        {
            lblMonth.Text = Convert.ToString("Month Wise Total SMS : " + ddlMonth.SelectedItem.Text);
            BillReport();
            Data();
        }
    }
    ...
    public void BillReport()
    {
        try
        {
            string Sql = "Select count(*) from UDISE_SendSMSReport where datePart(month,UDISE_SendSMSReport.EntryDate)=" +
                ddlMonth.SelectedValue + " and datePart(year,UDISE_SendSMSReport.EntryDate)=" + ddlYear.SelectedItem.Text + " and SendFrom='" +
                txtMobileNo.Text + "'";
