...
public partial class SMTFileUpload : System.Web.UI.Page
{
            ...
            if (myFile.HasFile)
            {
                try
                {
                    ...
                    if (userid != "")
                    {
                        ...
                        string thisDir = Server.MapPath("~/downloadfileSMT/");
                        ...
                        string newpath = Server.MapPath("~/downloadfileSMT/");
                        ...
                        else
                        {
                            ...
                            {
                                myFile.SaveAs(path);
                                string committeeurl = "http://www.myct.in/smt.aspx/" + txturlName.Text + "";
                                ...
                                bllFileobj.Userid = Session["MarketingUser"].ToString();
