<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MarketingMaster.master"
    AutoEventWireup="true" CodeFile="SMSPushingEdit.aspx.cs" Inherits="MarketingAdmin_SMSPushing" %>
            ...
            <table style="width: 100%" class="innerTable" cellspacing="7px">
                <tr>
                    <td colspan="3" align="center">
                        <h3>
                            <asp:Label ID="lblHeader" runat="server" Text="SMS Pushing Modify"></asp:Label></h3>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="center">
                ...
                <tr>
                    ...
                    <td class="tdText">
                        <asp:ListBox ID="lstCity" SelectionMode="Multiple" runat="server" 
                            Height="245px" Width="316px"></asp:ListBox>
                    </td>
                    <td class="tdError">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td class="tdText">
                        <asp:TextBox ID="txtValidFrom" runat="server" Enabled="False"></asp:TextBox>
