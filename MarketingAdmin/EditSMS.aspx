<%@ Page Language="C#" MasterPageFile="~/Master/MarketingMaster.master" AutoEventWireup="true"
    CodeFile="EditSMS.aspx.cs" Inherits="MarketingAdmin_EditSMS" Title="Untitled Page" %>
                                        ...
                                        <table style="width: 97%; height: 67px;" class="tblAdminSubFull1" cellspacing="0px">
                                            ...
                                            <tr>
                                                <td align="center" style="height: 31px;" colspan="3">
                                                    <asp:GridView ID="gvLongCodeSMS" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                        PageSize="10" OnPageIndexChanging="gvLongCodeSMS_PageIndexChanging" 
                                                        CssClass="mGrid"  DataKeyNames="pk"
                                                        OnRowCommand="gvLongCodeSMS_RowCommand" OnRowEditing="gvLongCodeSMS_RowEditing"
                                                        OnRowUpdating="gvLongCodeSMS_RowUpdating" 
                                                        onrowcancelingedit="gvLongCodeSMS_RowCancelingEdit">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkSelectMessage" runat="server" /></ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDate" runat="server" Font-Size="Small" Text='<%# Bind("shortcode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Status">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblFlag1" runat="server" Font-Size="Small" Text='<%# Bind("FlagStatus") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" style="height: 31px;">
                                                    <asp:Button ID="btnDataTransfer" runat="server" CssClass="button" 
                                                        OnClick="btnDataTransfer_Click" Text="Send" />
                                                    &nbsp;
