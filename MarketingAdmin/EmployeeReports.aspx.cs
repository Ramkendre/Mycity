...
public partial class MarketingAdmin_EmployeeReports : System.Web.UI.Page
{
    ...
    public void SendMail()
    {
        ...
        objMailMessage.From = new MailAddress("Pune@gmail.com");
        objMailMessage.To.Add("Mumbai@gmail.com");
        objMailMessage.Body = "Hi Friends Please FillUp the Report Form !!!";
        objMailMessage.IsBodyHtml = true;
        objMailMessage.Subject = "Reminder ToDay Work";
        SmtpClient objSmtpClient = new SmtpClient("smtp.gmail.com");
        objSmtpClient.Port = 587;
        objSmtpClient.UseDefaultCredentials = false;
        objSmtpClient.Credentials = new NetworkCredential("PuneMailId", "PunePassword");
