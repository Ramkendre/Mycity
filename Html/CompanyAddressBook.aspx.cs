...
public partial class html_CompanyAddressBook : System.Web.UI.Page
{
    DataTable dt;
        ...
        try
        {
            ...
            if (ddlMyFriendGroup.SelectedValue == "0")
            {
                if (txtGroupSMSFirst.Text != "" && txtGroupSMSLast.Text != "")
                {
                    ...
                    string newsql = "SELECT usrMobileNo,usrFirstName as usrFullName,usrAddress,usrDistrict,usrCity,usrPIN,usrCompanyName,usrMobileNo FROM FriendRelationMaster inner join UserMaster on " +
    ...
    protected void btntest_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("PrintAddressComp.aspx");
    ...
    private DataTable AddRow(GridViewRow gvRow, DataTable dt)
    {
        ...
        if (dr.Length <= 0)
        {
            ...
            dt.Rows[dt.Rows.Count - 1]["usrCompanyName"] = gvRow.Cells[5].Text;
            dt.Rows[dt.Rows.Count - 1]["usrmobileNo"] = gvRow.Cells[5].Text;
           // dt.Columns.Add("usrCompanyName");
