...
public partial class html_FileUpload : System.Web.UI.Page
{
    ...
    {
        string mono = Convert.ToString(Session["MobileNo"]);
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        if (myFile.HasFile)
        {
            try
            {
                ...
                string sql = "select usrAutoId, usruserid from usermaster where usrMobileNo='" + mobileno + "'";
    ...
    protected void btndownload_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select usruserid,SMSBal from usermaster where usrMobileNo='" + mobileno + "'";
        DataSet dset = cc.ExecuteDataset(sql);
        userid = Convert.ToString(dset.Tables[0].Rows[0]["usruserid"]);
        int SMSBal = Convert.ToInt32(dset.Tables[0].Rows[0]["SMSBal"]);
        ...
        string sqlinsert21 = "insert into frienddownloadlink(friendid,usr_url,frnd_url,flag)" +
                 "values('" + userid + "','" + urlstring + "','" + urlstring + "','" + flagstatus + "')";
        string b = cc.ExecuteScalar(sqlinsert21);
        ...
        if (drpdownfrnd.SelectedIndex == 1)
        {
            ...
            SMSBal = SMSBal - count;
            string sqlupdate = "update usermaster set SMSBal='" + SMSBal + "' where usruserid='" + userid + "'";
            int exec = cc.ExecuteNonQuery(sqlupdate);
