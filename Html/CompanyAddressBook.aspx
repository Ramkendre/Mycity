<%@ Page Language="C#" MasterPageFile="~/Master/MainMaster.master" AutoEventWireup="true" CodeFile="CompanyAddressBook.aspx.cs" Inherits="html_CompanyAddressBook" Title="Untitled Page" %>
                                ...
                                <asp:GridView ID="gvAddressBook" runat="server" AutoGenerateColumns="False" DataKeyNames="usrMobileNo"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField ItemStyle-Width="5px" DataField="usrPIN" HeaderText="Pincode">
                                         ...
                                         <asp:BoundField ItemStyle-Width="5px" DataField="usrCompanyName" HeaderText="Company Name">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle Width="5px" />
                                        </asp:BoundField>
