...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="updtPnlAttribute" runat="server">
        <ContentTemplate>
            <table class="innerTable" cellspacing="7px">
                ...
                <tr>
                    <td class="tdLabel">
                        <asp:Label ID="lblAttribute" runat="server" Text="Attribute Name:  "></asp:Label>
                        <label class="lblStar">
                            *</label>
                    </td>
                    <td class="tdText">
                ...
                <tr>
                    <td class="tdLabel">
                        <asp:Label ID="lblAttributeValue" runat="server" Text="Attribute Value:  "></asp:Label>
                    </td>
                    <td class="tdText">
                ...
                <tr>
                    <td colspan="3" align="center">
                        <asp:Button ID="btnSaveAttribute" runat="server" Text="Submit" CssClass="button-submit"
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="btnSaveAttribute" EventName="Click" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
