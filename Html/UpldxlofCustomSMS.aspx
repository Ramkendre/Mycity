<%@ Page Language="C#" MasterPageFile="~/Master/MainMaster.master" AutoEventWireup="true"
    CodeFile="UpldxlofCustomSMS.aspx.cs" Inherits="Html_UpldxlofCustomSMS" Title="Untitled Page" %>
                        ...
                        <td style="width: 51px; text-align: left;">
                            <div id="divMobile" runat="server" visible="False">
                                <table>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <asp:Label ID="lblMessage" runat="server" CssClass="lbl" ForeColor="#FB0000"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtCustMessage" runat="server" CssClass="tdText" TextMode="MultiLine"
                                                onkeyup="AllowOnlyNumeric4()" Height="130px" Width="248px" Enabled="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
