<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PromotionalDetails.aspx.cs"
    Inherits="PopUpFile_PromotionalDetails" %>
    ...
    <div>
        <table class="tblSubFull2" border="1">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Label ID="lblTotalSent" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left">
                ...
                <td align="left">
                    <asp:Label ID="lblTotallength" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left">
                ...
                <td align="left">
                    <asp:Label ID="lblTotalSms" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left">
